...
SECRET_KEY = 'django-insecure-$9qm$lw(nhlld@8g9dpetg(whigprc%9+8ebpqxcnggn66sd=e'
...
AUTH_USER_MODEL = 'account.Account'    # Tên model thay thế cho model user mặc định
